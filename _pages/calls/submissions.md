...
<div class="cfp-direction-grid">
  ...
  <section class="cfp-panel cfp-panel--agentic">
    ...
    <ul>
      ...
      <li>Agentic AI, ML, and LLMs for architecture documentation, knowledge extraction, design intelligence, and refactoring</li>
      <li>Agentic workflows for architecture review, modernization, compliance, and trade-off exploration</li>
      <li>Human-AI collaboration patterns for architecture work</li>
    </ul>
  </section>
</div>
